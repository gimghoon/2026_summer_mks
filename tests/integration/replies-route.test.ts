...
const candidates: [ReplyCandidate, ReplyCandidate, ReplyCandidate] = [
  { strategy: "relationship_soft", text: "다음에는 미리 말해주면 좋겠어", intentLabel: "관계 유지", riskLabel: null, contextBasis: ["말투: 짧고 부드럽게 답함"], warnings: [] },
  { strategy: "emotion_signal", text: "조금 기다리면서 아쉬웠어", intentLabel: "감정 전달", riskLabel: "돌려 들릴 수 있어", contextBasis: [NO_PERSONAL_CONTEXT_BASIS], warnings: ["emotional_inference"] },
  { strategy: "clearer_request", text: "늦을 때는 한마디만 해줘", intentLabel: "요청", riskLabel: null, contextBasis: [NO_PERSONAL_CONTEXT_BASIS], warnings: ["important_intent_ambiguity"] },
];
