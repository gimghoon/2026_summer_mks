...
test("shows named participant profile and reply links without exposing IDs", () => {
  render(<RoomParticipantList room={{ id: "room-1", title: "민수", updatedAt: "2026-08-08T00:00:00.000Z", analysisStatus: "ready", participants: [
  ...
  expect(screen.getByRole("link", { name: "민수 답장 만들기" })).toHaveAttribute("href", "/rooms/room-1/reply?participantId=person-1&relationship=female_friend");
