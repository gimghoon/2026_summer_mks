...
export function ProfileWorkspace({ roomId, participantId, participantName, relationship }: { roomId: string; participantId: string; participantName: string; relationship: "female_friend" | "girlfriend" }) {
